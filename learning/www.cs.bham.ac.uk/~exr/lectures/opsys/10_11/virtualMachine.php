...
<h1>School of Computer Science<br/>Personal Web Page</h1>
                    ...
                    <div id="breadcrumbs">
<a class="sys_0 sys_t3000" href="/">Computer Science</a>&nbsp;/&nbsp;<a href="/~exr/lectures" class="sys_0 sys_t166">Lectures</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys" class="sys_0 sys_t166">Opsys</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys/10_11" class="sys_0 sys_t166">10 11</a>&nbsp;/&nbsp;<span>VirtualMachine</span>
</div>          <div id="mainNav">
...
It contains an installation of Centos-5.5 which contains the same
essential software as the School installation (eg the C and
C++-compilers). In particular for kernel programming it is important
...
href=http://www.virtualbox.org/> VirtualBox </a> - follow the
  ...
  <LI>Copy the files <BR>
      /home/archive/exr/Centos-5.5.ovf <BR>
      /home/archive/exr/Centos 5.5.vmdk<BR>
      /home/archive/CenosSrc.vmdk <BR>
      (or \\socs-smb\archive\exr\Centos-5.5.ovf etc. as a Windows
      share) to your local machine <BR>
      <B> Warning: these files are huge (8GB in total), so the best way is to
      create two DVD's one with  /home/archive/exr/Centos 5.5.vmdk
      and the other one with  /home/archive/exr/Centos-5.5.ovf and
      /home/archive/CenosSrc.vmdk </B>
<LI> Start VirtualBox and import the file Centos-5.5.ovf. It should create
a new virtual machine named Centos-5.5.
...
come from your host computer, whereas incoming connections are
possible only from the host computer. This should be sufficient for
data transfer via scp, or mounting shares via smb. <P>
The root password is "opsys'11" (without the quotes), and there is
also a non-priviledged user with username "user" and password
"opsys'11". <P>
The virtual machine starts only with the command line. This is the
best way for kernel programming, as you can see immediately the error
messages on the console. If you want the graphical environment, log in
and execute the program "startx".<P>
