...
<h1>School of Computer Science<br/>Personal Web Page</h1>
                    ...
                    <div id="breadcrumbs">
<a class="sys_0 sys_t3000" href="/">Computer Science</a>&nbsp;/&nbsp;<a href="/~exr/lectures" class="sys_0 sys_t166">Lectures</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys" class="sys_0 sys_t166">Opsys</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys/10_11" class="sys_0 sys_t166">10 11</a>&nbsp;/&nbsp;<span>Exercises</span>
</div>          <div id="mainNav">
...
<UL>
 <LI> <a href=exercises/ex3.pdf> Assessed Exercise 3
    </a>. Deadline: 13 December, 24.00h. <BR> 
   <a href=examples/keyboardTiming.tgz> Example code for handling the keyboard interrupt </a> <BR>
   A software package containing the modified kernel ready for installation on the Project Lab Machine via the command "rpm -Uvh osKernel-1.0-1.i386.rpm" (executed as root) is available from /home/archive/exr/osKernel-1.0-1.i386.rpm. Please note: this package is not needed for the virtual machine.<BR>
   <a href=exercises/i8042.patch> Patch against stock centos-kernel </a>. These files are only necessary if you want to create your own customised kernel. These patches have already been applied to the virtual machine. <BR>
   <LI> <a href=exercises/ex4.pdf> Assessed Exercise 4
    </a>. Deadline: 17 January, 24.00h. <BR>
    <a href=lectures/os-dev.pdf> Background information </a> <BR>
  <a href=bootsector.php> How to execute a bootsector </a> <BR>
<a href=examples/bootsector> Bootsector examples </a> 
														  On the lab machines, you will need to install both the assembler as well as qemu. The relevant commands are (to be executed as root): <BR>
yum install nasm
yum install qemu
</UL>
