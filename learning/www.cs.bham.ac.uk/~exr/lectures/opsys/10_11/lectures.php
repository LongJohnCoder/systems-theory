...
<h1>School of Computer Science<br/>Personal Web Page</h1>
                    ...
                    <div id="breadcrumbs">
<a class="sys_0 sys_t3000" href="/">Computer Science</a>&nbsp;/&nbsp;<a href="/~exr/lectures" class="sys_0 sys_t166">Lectures</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys" class="sys_0 sys_t166">Opsys</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys/10_11" class="sys_0 sys_t166">10 11</a>&nbsp;/&nbsp;<span>Lectures</span>
</div>          <div id="mainNav">
...
For the lectures in the first six weeks, see <a href="http://www.cs.bham.ac.uk/~blundeln/secure/os_2010_2011/"> Nick Blundell's webpage </a> <P>

<TABLE Border=2> 
<TR> <TD> Slides </TD>
     <TD> Examples  </TD>
</TR>
<TR> <TD> <a href=lectures/21_security.pdf> Security </TD> <TD></TD> </TR>
<TR>
     <TD> <a href=lectures/c++.pdf> C++</TD>
     <TD> <a href=examples/c++/helloWorld.cpp> helloWorld.cpp </a> <BR> 
          <a href=examples/c++/classes.cpp> classes.cpp </a> <BR> 
          <a href=examples/c++/polygons.cpp> polygons.cpp </a> <BR> 
          <a href=examples/c++/list.cpp> list.cpp </a> <BR> 
          <a href=examples/c++/listLibrary.cpp> listLibrary.cpp </a> <BR> 
          <a href=examples/c++/vectornew.cpp> vectornew.cpp </a> <BR> 
          <a href=examples/c++/vectorAllocate.cpp> vectorAllocate.cpp </a> <BR> 
          <a href=examples/c++/memoryAllocation.cpp> memoryAllocation.cpp </a> 
     </TD>
</TR>     
<TR>
     <TD><a href=lectures/kernelProgramming.pdf> Kernel Programming </a></TD>
     <TD> <a href=examples/simpleModules.tgz> <tt> HelloWorld </tt>
     and  <tt> kernelRead </tt> modules</a> <BR>
    <a href=examples/writeData.c> User program to write data to file;
     used for writing data to kernel. </a> <BR>
    <a href=examples/keyboardTiming.tgz> Using keyboard interrupts </a><BR>
</TR>
<TR>
     <TD><a href=lectures/scheduling.pdf> Scheduling </a></TD>
</TR>
<TR>
     <TD><a href=lectures/memory.pdf> Memory management </a></TD>
</TR>
<TR>
     <TD><a href=lectures/deviceDrivers.pdf> Device Drivers </a></TD>
</TR>
<TR>
     <TD><a href=lectures/filesys.pdf> File systems </a></TD>
</TR>
<TR>
     <TD> Example of memory leak</TD>
     <TD> <a href=examples/memoryLeak/checkURLbad.c> Program with errors </a> <BR>
          <a href=examples/memoryLeak/checkURLCorrected.c> Program with errors corrected. </a> </TD>
</TR>     
<TR>
     <TD><a href=lectures/embedded.pdf> Embedded Systems </a></TD>
</TR>
<TR>
     <TD><a href=lectures/architectures.pdf> Kernel Architectures </a></TD>
</TR>
