...
<h1>School of Computer Science<br/>Personal Web Page</h1>
                    ...
                    <div id="breadcrumbs">
<a class="sys_0 sys_t3000" href="/">Computer Science</a>&nbsp;/&nbsp;<a href="/~exr/lectures" class="sys_0 sys_t166">Lectures</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys" class="sys_0 sys_t166">Opsys</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys/10_11" class="sys_0 sys_t166">10 11</a>&nbsp;/&nbsp;<span>Bootsector</span>
</div>          <div id="mainNav">
...
</h1><div id="wideContent"><h2>Run your own bootsector</h2>
If you use qemu, you can run your bootsector directly with the command <BR>
<tt> qemu &lt;bootsector&gt; </tt> <P>

If you use virtualbox, you need to create a suitable file first. Use the following steps:

<UL> 
    <LI> Transform the bootsector into a file which VirtualBox recognises as a hard disk via the command <BR>
    <tt> VBoxManage convertfromraw --format VDI &lt;bootsector&gt; &lt;hardDiskFile.vdi&gt; </tt> <BR>
    Now copy the file  &lt;hardDiskFile.vdi&gt; </tt> into the directory where VirtualBox, normally <tt> ~/.VirtualBox/HardDisks </tt> 
			     <LI> Now select the above hard disk as the disk for a virtual machine 
<LI>
Boot this virtual machine
</UL>
