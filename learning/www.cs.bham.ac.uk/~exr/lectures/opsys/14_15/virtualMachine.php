...
<head>
<title>Operating Systems 2014/15</title>
...
<h1>School of Computer Science<br/>Personal Web Page</h1>
                    ...
                    <div id="breadcrumbs">
<a class="sys_0 sys_t3000" href="/">Computer Science</a>&nbsp;/&nbsp;<a href="/~exr/lectures" class="sys_0 sys_t166">Lectures</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys" class="sys_0 sys_t166">Opsys</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys/14_15" class="sys_0 sys_t166">14 15</a>&nbsp;/&nbsp;<span>VirtualMachine</span>
</div>          <div id="mainNav">
...
href=http://www.virtualbox.org/> VirtualBox </a> - follow the
  ...
  <LI>Copy the files <BR>
      /home/archive/exr/Ubuntu 14.04 (OS C).ova<BR>
      (or \\socs-smb\archive\exr\Ubuntu 14.04 (OS C).ova as a Windows
      share) to your local machine <BR>
      <B> Warning: this files are huge (over 2GB in total), so the best way is to
      use a USB memory stick or bring your laptop into the School and use the wireless network to copy the files. </B>
...
The root password is "opsys'14" (without the quotes), and there is
