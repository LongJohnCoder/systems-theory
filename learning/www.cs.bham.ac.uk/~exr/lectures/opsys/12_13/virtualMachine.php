...
<h1>School of Computer Science<br/>Personal Web Page</h1>
                    ...
                    <div id="breadcrumbs">
<a class="sys_0 sys_t3000" href="/">Computer Science</a>&nbsp;/&nbsp;<a href="/~exr/lectures" class="sys_0 sys_t166">Lectures</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys" class="sys_0 sys_t166">Opsys</a>&nbsp;/&nbsp;<a href="/~exr/lectures/opsys/12_13" class="sys_0 sys_t166">12 13</a>&nbsp;/&nbsp;<span>VirtualMachine</span>
</div>          <div id="mainNav">
...
It contains an installation of Ubuntu 10.04 which contains all the necessary 
...
href=http://www.virtualbox.org/> VirtualBox </a> - follow the
  ...
  <LI>Copy the files <BR>
      /home/archive/exr/Ubuntu 10.04 (OS).ovf <BR>
      /home/archive/exr/Ubuntu 10.04 (OS).vmdk<BR>
      (or \\socs-smb\archive\exr\Ubuntu 10.04 (OS).ovf etc. as a Windows
      share) to your local machine <BR>
      <B> Warning: these files are huge (almost 2GB in total), so the best way is to
      create one DVD or bring your laptop into the School and use the wireless network to copy the files. </B>
<LI> Start VirtualBox and import the file Ubuntu 10.04 (OS).ovf. It should create
a new virtual machine named Ubuntu 10.04.
